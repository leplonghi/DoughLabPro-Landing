      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {FEATURES_LIST.map((feature) => {
            const isAssistant = feature.titleKey === 'features.list.assistant.title';
            return (
              <div 
                key={feature.titleKey} 
                className={`bg-secondary/50 dark:bg-dark-card p-6 rounded-lg text-left ${isAssistant ? 'relative group' : ''}`}
              >
                ...
                {isAssistant && (
                   ...
                   >
                     {t('features.list.assistant.tooltip')}
